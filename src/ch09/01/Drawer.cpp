 ...
 * @LastEditTime: 2023-04-05 18:32:39
 * @Description:
 * guijiyang@163.com
...
void Drawer::init(GLFWwindow *window) {
  ...
  texture_ids_[0] = setupTexture("texture/cube_map2.png");
...
void Drawer::display(GLFWwindow *window, double current_time) {
  ...
  activateTexture(texture_ids_[1]); // Activate the texture and bind it to a texture unit
