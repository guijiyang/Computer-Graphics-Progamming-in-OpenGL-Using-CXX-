 ...
 * @LastEditTime: 2023-03-26 17:12:43
 * @Description:
 * guijiyang@163.com
...
void Drawer::display(GLFWwindow *window, double current_time) {
  ...
  // //  look at the sun
  // vmat_ = glm::lookAt(glm::vec3(cam_pos_.x, cam_pos_.y, cam_pos_.z),
  //                     glm::vec3(0.0f, 0.0f, 0.0f),
  //                     glm::normalize(glm::vec3(cam_pos_.z, 0.0f,
  //                     -cam_pos_.x)));
  // //  look at the planet
  // vmat_ =
  //     glm::lookAt(glm::vec3(cam_pos_.x, cam_pos_.y, cam_pos_.z),
  //                 glm::vec3(sin(static_cast<float>(current_time)) * 4.0,
  //                 0.0f,
  //                           cos(static_cast<float>(current_time)) * 4.0),
  //                 glm::normalize(glm::vec3(cos(static_cast<float>(current_time))*4.0-
  //                 cam_pos_.z, 0.0f,
  //                 cam_pos_.x-sin(static_cast<float>(current_time))*4.0)));

  //  look at the moon
  vmat_ = glm::lookAt(
      glm::vec3(cam_pos_.x, cam_pos_.y, cam_pos_.z),
      glm::vec3(sin(static_cast<float>(current_time)) * 4.0f, sin(static_cast<float>(current_time)) * 2.0f,
                cos(static_cast<float>(current_time)) * 6.0f),
      glm::normalize(glm::vec3(
          0.0f,cam_pos_.z-cos(static_cast<float>(current_time))*6.0f,
          sin(static_cast<float>(current_time)) * 2.0f)-cam_pos_.y));
